...
export function getCommand(modules: Map<string, ICommand[]>, commandName: string): ICommand {
    return flatArray([...modules.values()]).find((cmd) => cmd.name === commandName.toLowerCase());
}
